Feature: Searching session by relevancy
  ...
  Scenario: Displaying relevants sessions
    ...
    And An unsposored session created by Theo of "Wing chun" at "2030-02-01T12:00:00.000+01:00[Europe/Paris]" with granted access
    When Karl do a default search on the sessions
    Then Karl should find the sessions with the following order: "Yoseikan Budo, Wing chun"